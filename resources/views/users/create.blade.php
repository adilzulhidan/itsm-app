                ...
                <form action="{{ route('users.store') }}" method="POST" class="p-8" id="userForm">
                        ...
                        <div class="space-y-6">
                            <div class="form-group transition-all duration-200">
                                ...
                                <select name="department" 
                                    ...
                                    <option value="GA" {{ (old('department', $user->department ?? '') == 'Purchasing/Exim') ? 'selected' : '' }}>Purchasing/Exim</option>
                                    <option value="Marketing" {{ (old('department', $user->department ?? '') == 'Sales') ? 'selected' : '' }}>Sales</option>
                                    <option value="Marketing" {{ (old('department', $user->department ?? '') == 'PPIC') ? 'selected' : '' }}>PPIC</option>
                                    <option value="Marketing" {{ (old('department', $user->department ?? '') == 'QC') ? 'selected' : '' }}>QC</option>
                                </select>
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center pt-6 border-t border-gray-200">
                        ...
                        <div class="flex items-center space-x-4">
                            <button type="reset" 
                                    class="flex items-center px-6 py-3 text-gray-700 border border-gray-300 rounded-xl hover:bg-gray-50 transition-all duration-200">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button type="submit" 
                                    class="group relative flex items-center px-8 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium rounded-xl shadow-lg hover:shadow-xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 transform hover:-translate-y-0.5">
